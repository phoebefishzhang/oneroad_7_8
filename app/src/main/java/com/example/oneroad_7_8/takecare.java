            ...
            public void onClick(View v) {
                ...
                if(CB1.isChecked() && CB2.isChecked() && CB3.isChecked() && CB4.isChecked() && CB5.isChecked() && CB6.isChecked() && CB7.isChecked() && CB8.isChecked() && CB9.isChecked()){
                    ...
                    new Thread(()->{
                        ...
                        int totalsum=ref2.getInt("totalsum",0);
                        ...
                        String reason1=ref4.getString("reason","");
                        String reason2=ref4.getString("reason1","");
                        ...
                        String tool3=ref7.getString("tool3","");
                        ...
                        patient.put("體重","60");
                        patient.put("reason",reason1);
                        patient.put("otherreason",reason2);
