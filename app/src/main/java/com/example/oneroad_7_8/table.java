...
public class table extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      showid=findViewById(R.id.showpatientid);
      showid.setText(patientnum);
        ...
        if(test1_1==0 && road==0 && test2==0 && test3==0 && test4==0 && test5==0 && test6 ==0){
            if(patientnum.equals("")){
                Toast.makeText(table.this, "尚未開始診斷", Toast.LENGTH_SHORT).show();
            }
            db.collection("patientlist").document(patientnum).get()
                    .addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                            ...
                            Log.d(TAG, "Cached document data7: " +patientnum);
